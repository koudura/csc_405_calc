//operators object
operators = {
    "(": {"pre": 0, "rule": 0, "unary": 0},
    "+": {
        "pre": 2, "rule": 0, "unary": 0, "func": (a, b) => {
            return a + b;
        }
    },
    "-": {
